 ...
 *
 * v2.3.2：220 → 320。用一份 35 人 / 6 级、含长中文+英文岗位名的样本，在 Chromium 实测：
 * - 负责人行自然宽 194px（220 时已经贴边）；
 * - 部门名自然宽最大 247px（形如「XX.X 中文部门名（括号后缀）」，18 字符），加折叠箭头与 L 级标记后需 ~345px；
 * - 岗位名自然宽最大 374px（形如「中文岗位名 - Position Title With Several Words」）—— 这个长度任何合理卡宽都放不下，
